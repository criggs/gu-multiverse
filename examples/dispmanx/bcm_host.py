...
vc_dispmanx_snapshot.argtypes = (ct.c_uint32, ct.c_uint32, ct.c_uint32)
...
vc_dispmanx_resource_read_data.argtypes = (ct.c_uint32, ct.POINTER(VC_RECT_T), ct.c_void_p, ct.c_uint32)
vc_dispmanx_snapshot.restype = ct.c_int
